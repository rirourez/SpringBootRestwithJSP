	...
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"> <a th:href="@{/home}" class="nav-link">Home</a></li>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				...
				<span class="brand-text font-weight-light">CRM PRO</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="#" class="d-block">Rebhy Ryadh</a>
					</div>
				</div>
 ...
 -->
						...
						<li class="nav-item has-treeview"><a href="#"
							class="nav-link"> <i class="nav-icon fas fa-copy"></i>
								<p>
									Project <i class="fas fa-angle-left right"></i> <span
										class="badge badge-info right">6</span>
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath}/viewProject"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Projects</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath}/addProject"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Add Project</p>
								</a></li>
						...
						<li class="nav-item has-treeview"><a href="#"
							class="nav-link"> <i class="nav-icon fas fa-chart-pie"></i>
								<p>
									Task <i class="right fas fa-angle-left"></i>
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath}/viewTask"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Tasks</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath}/addTask"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Add Task</p>
								</a></li>
							...
							<div class="card">
								<div class="card-header">
									...
									<button class="btn btn-primary float-sm-right"
										onclick="window.location.href='/admin/addUser';">Add
										User</button>
	...
	<footer class="main-footer">
		<strong>Copyright &copy; 2021 Jhsoftwares All rights
			reserved.
								...
								$("#users")
										.append(
												"<tr class='tr'> <td> "
														...
														+ " </td>  <td> "
														+ response.data[i].etatStr
														+ " </td>  <td> <a href='#' onclick= edit("
														+ response.data[i].user_id
														+ ");> Edit </a>  </td> </td> <td> <a href='#' onclick='deleteUser_("
														+ response.data[i].user_id
														+ ");'> Delete </a>  </td> </tr>");
							}
						}
