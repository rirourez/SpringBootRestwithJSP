				...
				<div class="card card-primary">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<label for="phone">Phone</label> <input type="text"
								class="form-control" required id="phone" name="phone"
								placeholder="Phone">
						</div>
						...
						<div class="form-group">
							<label for="address">Address</label> <input type="text"
								class="form-control" required id="address" name="address"
								placeholder="Address">
						</div>

						<div class="form-group">
							<label for="address">Etat</label> <select class="form-control"
								required id="etat" name="etat" placeholder="Etat">
								<option value=""></option>
					...
					<div class="card-footer">
						...
						<button class="btn btn-primary"
							onclick="window.location.href='/admin/viewUser';">View
							User</button>
